...
public class QaDIMDAO {
    ...
    public static void createQadimProduct(String userID , String projectName , Integer productID){
        Connection conn = null ;
        PreparedStatement pstmt = null ;
        ResultSet rs = null ;
        String sql = "INSERT into qadim_product (userid , project_name , product_id) values(? , ? , ?); ";
        try {
                conn = ConnectionManager.getConnection();
                conn.setAutoCommit(false);
